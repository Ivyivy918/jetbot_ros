...
class StereoDepthNode(Node):
    ...
    def load_calibration(self):
        ...
        # baseline = -Tx / fx（Tx 在右相機 projection matrix 的 [0,3]）
    ...
    def image_callback(self, left_msg, right_msg):
        ...
        throttle_duration_sec=1.0
            ...
            mask = depth > 0
            if mask.any():
                d_norm = np.clip(depth, 0.1, 5.0)  # 顯示 0.1~5m
                d_u8 = ((d_norm - 0.1) / 4.9 * 255).astype(np.uint8)
